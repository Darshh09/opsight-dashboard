...
import { IconMenu2, IconX, IconBrain, IconRocket, IconEye } from "@tabler/icons-react";
import {
  motion,
  AnimatePresence,
  useScroll,
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-black/95 px-4 py-8 shadow-2xl border border-gray-800 backdrop-blur-md",
            className,
          )}
        >
          {children}
...
export const NavbarLogo = () => {
  ...
  return (
    ...
    >
      ...
      <span className="font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">OpsSight</span>
    </motion.a>
  );
};
